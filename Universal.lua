...
runFunction(function()
	...
	local SilentAimWallCheck = {Enabled = true}
	...
	local SilentAimWallbang = {Enabled = true}
...
runFunction(function()
	local Hitboxes = {Enabled = true}
	local HitboxMode = {Value = "HumanoidRootPart"}
	local HitboxExpand = {Value = 49}
...
runFunction(function()
	local Speed = {Enabled = true}
	local SpeedValue = {Value = 30}
...
runFunction(function()
	...
	local ESPHealthBar = {Enabled = true}
...
runFunction(function()
	...
	local NameTagsDisplayName = {Enabled = true}
	local NameTagsHealth = {Enabled = true}
	local NameTagsDistance = {Enabled = true}
...
runFunction(function()
	local FieldOfView = {Enabled = true}
...
runFunction(function()
	local Breadcrumbs = {Enabled = true}
	local BreadcrumbsLifetime = {Value = 50}
...
runFunction(function()
	local AutoReport = {Enabled = true}
	local AutoReportList = {ObjectList = {}}
	local AutoReportNotify = {Enabled = true}
...
runFunction(function()
	local cameraunlock = {Enabled = true}
	local cameraunlockdistance = {Value = 999}
